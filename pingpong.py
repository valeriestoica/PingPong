...
win.bgcolor('Old Lace')   # providing color to the HomeScreen
...
paddle_left.color('Dark Sea Green')
...
paddle_right.color('Dark Sea Green')
paddle_right.penup()
...
pen.hideturtle()
pen.goto(0,260)
pen.write("Player A: 0                    Player B: 0 ",align="center",font=('Segoe',24,"normal"))
...
while True:
    ...
    if ball.xcor() > 390:   # right width paddle Border
        ...
        pen.clear()
        pen.write("Player A: {}                    Player B: {} ".format(player_a_score,player_b_score),align="center",font=('Segoe',24,"normal"))
